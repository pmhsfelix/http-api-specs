...
Links                            | [Web Linking](#web-linking)
Links                            | [URI Template](#uri-template)
Links                            | [IANA Link Relation registry](#iana-link-relation-registry)
Generic Media Types              | [JSON Hypertext Application Language](#json-hypertext-application-language)
Generic Media Types              | [Siren](#siren)
Generic Media Types              | [Collection+JSON](#collectionjson)
Generic Media Types              | [JSON API](#json-api)
Other Media Types                | [Problem Details for HTTP APIs](#problem-details-for-http-apis)
Other Media Types                | [Home Documents for HTTP APIs](#home-documents-for-http-apis)
Semantics                        | [The ‘profile’ Link Relation Type](#the-profile-link-relation-type)
Negotiation                      | [Prefer Header for HTTP](#prefer-header-for-http)
Caching                          | [HTTP Cache-Control Extensions for Stale Content](#http-cache-control-extensions-for-stale-content)
Security                         | [Hypertext Transfer Protocol (HTTP/1.1): Authentication](#hypertext-transfer-protocol-http11-authentication)
Security                         | [The OAuth 2.0 Authorization Framework](#the-oauth-20-authorization-framework)
Security                         | [The OAuth 2.0 Authorization Framework: Bearer Token Usage](#the-oauth-20-authorization-framework-bearer-token-usage)
Security                         | [OpenID Connect Core 1.0](#openid-connect-core-10)
Security                         | [IANA HTTP Authentication Schemes registry](#iana-http-authentication-schemes-registry)
Syntax                           | [Hypertext Transfer Protocol (HTTP/1.1): Message Syntax and Routing](#hypertext-transfer-protocol-http11-message-syntax-and-routing)
Syntax                           | [Uniform Resource Identifier (URI): Generic Syntax](#uniform-resource-identifier-uri-generic-syntax)
